...
var topics = ["Hubble", "Orbital", "Golden Ratio", "Nautilus", "Fibonacci", "Cymatics", "Lava", "Black Hole"];
...
$("#buttonArea").on("click", ".btn", function(){
  		...
  		var queryURL = "https://api.giphy.com/v1/gifs/search?q=" + thing + "&api_key=dMZYNYSTzBMj5uwkWTRbK2VZKajkrFFd";
